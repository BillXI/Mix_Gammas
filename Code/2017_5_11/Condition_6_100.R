...
out_6_100_1 <- vector("list",B) #Rename for each condition and sample size; e.g., Condition 2 --> out_2_100_1, Condition 3 --> out_3_100_1, etc.
out_6_100_2 <- vector("list",B) #Rename for each condition and sample size; e.g., Condition 2 --> out_2_100_2, Condition 3 --> out_3_100_2, etc.
i <- 0
while(i < B){
        i <- i+1
...
save.image(file="./Result/2017_5_11/6_100.Rd")
